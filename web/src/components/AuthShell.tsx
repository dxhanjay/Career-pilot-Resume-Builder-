      ...
      <aside className="hidden bg-ink-950 lg:flex lg:flex-col lg:justify-center lg:px-16">
        <blockquote className="max-w-md">
          <p className="text-2xl font-medium leading-relaxed text-white">
            A student applies to 200 internships, hears nothing from 190, gets rejected by 9, and
            is told why by exactly&nbsp;zero.
          </p>
          <footer className="mt-6 text-sm leading-6 text-ink-300">
            CareerPilot shows you what the machine actually read from your resume, scores it
            against the rules screeners use, and quotes your own words back as the evidence for
            every finding.
          </footer>
        </blockquote>
        ...
        <ul className="mt-12 max-w-md space-y-4 text-sm text-ink-300">
          {[
            ...
            <li key={item} className="flex gap-3">
              <svg
                viewBox="0 0 20 20"
                className="mt-0.5 h-5 w-5 shrink-0 fill-brand-400"
                aria-hidden="true"
              >
                <path
                  fillRule="evenodd"
