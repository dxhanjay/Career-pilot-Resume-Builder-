...
export type Tone = 'emerald' | 'brand' | 'amber' | 'red' | 'slate'

/** Static class names, because Tailwind cannot see a template-built one. */
export const TONE_CLASSES: Record<string, Record<string, string>> = {
  emerald: {
...
export const RESUME_STATUS: Record<string, { label: string; tone: Tone }> = {
