...
export function Alert({ tone = 'red', title, children, action, className }) {
 ...
 * value on the page.
 */
export function ScoreRing({ score = 0, tone = 'brand', size = 120, label, sublabel }) {
...
export function ScoreBar({ score = 0, tone = 'brand', label, hint }) {
  const palette = TONE_CLASSES[tone] ?? TONE_CLASSES.brand
  return (
    <div>
